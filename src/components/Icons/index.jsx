...
export const TelegramIcon = ({ className }) => (
  <svg
    ...
    xmlns="http://www.w3.org/2000/svg"
  >
    <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.562 8.161c-.18.717-.962 4.084-1.362 5.411-.168.56-.505 1.282-.832 1.282-.236 0-.441-.158-.677-.334-.37-.275-1.583-1.092-2.137-1.442-.16-.101-.309-.168-.432-.168-.198 0-.323.109-.508.311-.263.287-1.127 1.238-1.385 1.517-.258.279-.516.313-.805.158-.29-.155-1.25-.436-2.383-1.155-.875-.555-1.547-1.239-1.547-1.239-.427-.376.014-.582.47-.852.062-.037 4.14-2.613 4.195-2.671.071-.073.136-.207-.015-.207-.152 0-3.535 2.148-3.955 2.404-.42.256-.84.341-1.144.256-.304-.085-1.306-.411-1.925-.615-.62-.204-.668-.314-.15-.512.316-.121 5.337-2.14 8.784-3.52.888-.356 1.764-.533 2.628-.533.411 0 .805.04 1.18.12.375.08.647.218.815.414.168.196.257.447.266.753.009.306-.027.643-.108.974z" />
  </svg>
);
...
export const FavoriteStarIcon = ({ className }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
...
export const DeleteCrossIcon = ({ className }) => (
  <svg
    viewBox="0 0 24 24"
    fill="currentColor"
    className={className}
