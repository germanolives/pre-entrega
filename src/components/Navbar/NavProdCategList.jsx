...
export const NavProdCategList = ({ data, listMenuView, resetMenuView }) => {
  ...
  return (
    <>
      {listMenuView && (
        <ul
          className={`flex flex-col gap-2 ${isAdmin ? "bg-green-200" : "bg-slate-200"} p-2 min-w-30 z-50 rounded-xl md:absolute md:top-full md:left-0 md:shadow-md md:border md:border-gray-400`}
        >
          {sortedData.map((item) => {
